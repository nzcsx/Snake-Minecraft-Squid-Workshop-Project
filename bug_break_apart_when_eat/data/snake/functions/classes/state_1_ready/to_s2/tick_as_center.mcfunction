...
#       Start
execute as @a[scores={shift_begin=1}] if score @s snake_cuid = @e[tag=this_center,limit=1] snake_cuid run function snake:classes/state_1_ready/to_s2/player_input
